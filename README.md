 ...
 * [`benchmark_assignment_rollinghorizon.mos`](benchmark_assignment_rollinghorizon.mos): This model implements the system configuration optimization on a rliing horizon basis (RO method).
